package davBag.first_proj.catch_the_drop;
...
public class GameWindow extends JFrame {
    ...
    private static void onRepaint(Graphics graphics) {
        ...
        float delta_time = (current_time - last_frame_time) * 0.000000001f; //разница во времени в секундах
        ...
        if (drop_top > game_window.getHeight()) graphics.drawImage(game_over, 180, 120, null);
    }
